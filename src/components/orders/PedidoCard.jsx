...
export const PedidoCard = ({
  ...
  return (
    <div
      className={`flex flex-row border border-black border-opacity-20 ${bgColor} p-4 mb-[-10px] gap-4 hover:bg-gray-300 transition-transform duration-300 ease-in-out ${
          ...
          <div>
            ...
            <p className="text-black text-xs font-medium font-coolvetica">
              {metodoPago === 'efectivo' || metodoPago === 'ambos'
                ? `Cobrar: ${currencyFormat(efectivoCantidad)}`
                : `Cobrar: PAGADO`}
            </p>
...
PedidoCard.propTypes = {
  ...
  efectivoCantidad: PropTypes.number.isRequired,
