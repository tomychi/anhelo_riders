...
export const PedidoCard = ({
	...
	<div
		className={`flex flex-row justify-between bg-gray-200 hover:bg-gray-300 transition-transform duration-300 ease-in-out ${
			isVisible ? "transform-none" : "transform -translate-y-full"
		}`}
		style={{ transitionDelay: `${index * 100}ms` }}
	>
		<div className="flex flex-col p-4">
			<p className="uppercase mb-2 mt-2  font-black text-black font-antonio">
				{direccion}
			</p>
			<p className="text-black text-xs font-black font-antonio">
